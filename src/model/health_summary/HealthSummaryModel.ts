...
export class HealthSummaryThreadModel implements HealthSummaryThread {
  ...
  static fromJson(json: { [key: string]: any }): HealthSummaryThreadModel {
    ...
    if (json["healthSummaryAttachement"] != null) {
      model.healthSummaryAttachment = (
        json["healthSummaryAttachement"] as any[]
      ).map((v) => HealthSummaryThreadAttachmentModel.fromJson(v));
    }
    return model;
  }
...
export class HealthSummaryThreadAttachmentModel
  implements HealthSummaryThreadAttachment
{
  attachmentId?: number;
  ...
  static fromJson(json: {
    [key: string]: any;
  }): HealthSummaryThreadAttachmentModel {
