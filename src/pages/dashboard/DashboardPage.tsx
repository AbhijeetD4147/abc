  ...
  return (
    <div className="flex flex-col h-screen w-screen font-[Segoe UI]">
      ...
      <div className="block sm:hidden">
        {/* Mobile Navbar */}
        <div className="w-full bg-blue-500 px-4 py-3">
          <div className="flex justify-between items-center">
            {/* User Info */}
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-white text-blue-500 flex items-center justify-center rounded-full text-lg font-bold">
                {userInitials}
              </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col h-full">
            {/* Menu Items Section - Blue Background */}
            <div className="bg-blue-500 text-white px-6 py-8">
              <div className="grid grid-cols-3 gap-6">
                {menuItems.map((item, idx) => (
                  <div key={idx} className="flex flex-col items-center text-center">
                    <div
                      className="w-16 h-16 border-2 border-white rounded-full flex items-center justify-center hover:bg-blue-600 cursor-pointer transition-colors mb-2"
                    ...
                    <p className="text-sm text-center leading-tight">{item.label}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      {/* Desktop/Tablet Layout - Hidden on small screens, visible on sm and above */}
      <div className="hidden sm:block">
        ...
        {loading ? (
          ...
          <div className="flex h-full">
            {/* Sidebar */}
            <div className="w-full lg:w-1/2 bg-blue-500 text-white flex flex-col justify-center items-center gap-4 px-4 sm:px-8 lg:px-16 py-8 lg:py-0">
