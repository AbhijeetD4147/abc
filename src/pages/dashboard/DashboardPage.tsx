                ...
                <div key={idx} className="flex flex-col items-center text-center">
                  <div className="border-2 rounded-full p-4 sm:p-6 lg:p-8 flex items-center justify-center hover:bg-blue-600 cursor-pointer">
                    {React.cloneElement(item.icon, {
                      badgeContent: idx === 0 ? appointmentData.messageUnreadCount : 
                                    idx === 1 ? appointmentData.appointmentUnreadCount :
                                    idx === 3 ? appointmentData.healthSummaryUnreadCount : "0",
                      isbadge: parseInt(idx === 0 ? appointmentData.messageUnreadCount : 
                                      idx === 1 ? appointmentData.appointmentUnreadCount :
                                      idx === 3 ? appointmentData.healthSummaryUnreadCount : "0") > 0
                    })}
                  </div>
